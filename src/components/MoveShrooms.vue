<template>
      <div draggable="false" class="small-box shroom" :id="mShroom.id" :class="'position' + mShroom.location + ' ' + (mShroom.disabled ? 'disabled' : '')" @click="hitShroom(mShroom.id)" >
          <img v-if="mShroom.img == 3" :id="'shroom'+mShroom.id" :style="'left: '+mShroom.width+'px; top: '+mShroom.height+'px;'" class="small-box btn m-0" draggable="false" :title="mShroom.name" src="../assets/sprites/52fbabf78842929.png" alt="Basic-Shroom">
